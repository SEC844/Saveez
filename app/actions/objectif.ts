...
export async function createObjectifAction(
  ...
  const validCategories = ["standard", "vacances", "autre", "famille"];
  ...
  const categorieLabel = categorie === "vacances" ? "Vacances" : categorie === "autre" ? "Autre" : categorie === "famille" ? "Famille" : "Standard";
