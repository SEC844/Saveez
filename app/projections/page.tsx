...
export default async function ProjectionsPage() {
  ...
  const [graphData] = await Promise.all([
    getGraphData(session.user.id, user.objectifBase, imprévusActifs, objectifs),
  ]);
  const comptesActifs = dashboardData.comptes.filter((c) => c.actif);
